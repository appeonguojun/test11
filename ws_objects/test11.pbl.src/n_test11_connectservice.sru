$PBExportHeader$n_test11_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_test11_connectservice from nonvisualobject
end type
end forward

global type n_test11_connectservice from nonvisualobject
end type
global n_test11_connectservice n_test11_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "D:\Appeon_Work\test11\test11.ini"
...
on n_test11_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_test11_connectservice.destroy
