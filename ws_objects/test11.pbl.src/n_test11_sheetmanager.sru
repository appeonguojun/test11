$PBExportHeader$n_test11_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_test11_sheetmanager from nonvisualobject
end type
end forward

global type n_test11_sheetmanager from nonvisualobject
end type
global n_test11_sheetmanager n_test11_sheetmanager

type variables
string is_sheets[], is_display[]
w_test11_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_test11_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_test11_frame, 0, Cascaded! ) 
...
w_test11_basesheet lw_sheets[], lw_init[]
...
w_test11_sheet1	lw_sheet1
w_test11_sheet2	lw_sheet2
w_test11_sheet3	lw_sheet3
...
on n_test11_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_test11_sheetmanager.destroy
