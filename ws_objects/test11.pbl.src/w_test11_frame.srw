$PBExportHeader$w_test11_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_test11_frame from window
end type
type mdi_1 from mdiclient within w_test11_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_test11_frame"
...
global w_test11_frame w_test11_frame

type variables
n_test11_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_test11_basesheet aw_sheet)
public function long of_classcount (readonly w_test11_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_test11_frame am_menu)
end prototypes
...
string ls_sheets[]  = { "w_test11_sheet1", "w_test11_sheet2", "w_test11_sheet3" }
...
inv_sheetmgt = Create n_test11_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_test11_frame.create
if this.MenuName = "m_test11_frame" then this.MenuID = create m_test11_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_test11_frame.destroy
